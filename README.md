...
(NOTE: This uses both custom items and player icons which are in experimental and will prevent you from publishing maps with this until they exit experimental)
